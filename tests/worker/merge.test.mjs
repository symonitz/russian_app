...
test("pattern progress merges like vocab (known beats learning)", () => {
  const local = { vocab: {}, letters: {}, patterns: { 3: { state: "learning", reps: 1, due: 0 } }, counter: 0 };
  const server = { vocab: {}, letters: {}, patterns: { 3: { state: "known", reps: 2, due: 0 } }, counter: 0 };
  const m = mergeProgress(local, server);
